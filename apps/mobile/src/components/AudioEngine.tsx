...
export default function AudioEngine() {
  ...
  useEffect(() => {
    ...
    const newSrc = track.filePath.startsWith('blob:') || track.filePath.startsWith('data:') || track.filePath.startsWith('http')
      ? track.filePath
      : ((window as any).__resolveTrackAudioUrl ? (window as any).__resolveTrackAudioUrl(track.id, normalizedPath) : `media:///${normalizedPath}`);
